function Task1()
{
    function Car(manufacturer, model, year, averageSpeed) 
    {
        ...
        this.calculateTimeDistance = function (distance)
        {
...
function Task2()
{
    function Fraction(numerator, denominator) 
    {
        ...
        this.additionFraction = function (secondFraction) 
        {
            ...
            {
                const NOK = nok(this.denominator, secondFraction.denominator);
        ...
        this.subtractionFraction = function (secondFraction) 
        {
            if(this.denominator == secondFraction.denominator)
            {
                return new Fraction(this.numerator + secondFraction.numerator, this.denominator); 
        ...
        this.reductionFraction = function () 
        {
            let temp = this;
            let integer = 0;
...
function Task3()
{
    function Time(hours, minutes, seconds) 
    {
        ...
        this.addSeconds = function (numSec)
        {
            this.seconds += numSec;
            if(this.seconds > 60)
            {
        ...
        this.addMinutes = function (numMin)
        {
            this.minutes += numMin;
            if(this.minutes > 60)
            {
        ...
        this.addHours = function (numHours)
        {
            this.hours += numHours;
            if(this.hours > 24)
            {
    ...
    let fraction1 = new Time(25, 90, 90);
    alert(`Создание объекта с параметрами (25, 90, 90) = ${fraction1.showTime()}`);
